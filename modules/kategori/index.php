...
<div class="page-header">
  ...
  <a href="/modules/kategori/create.php" id="btn-tambah-kategori" class="btn btn--primary">
...
<form method="GET" action="<?= APP_BASE ?>/modules/kategori/index.php" class="search-form" role="search">
  ...
  <?php if ($search): ?>
    <a href="/modules/kategori/index.php" class="btn btn--ghost">Reset</a>
  <?php endif; ?>
</form>
          ...
          <tr>
            ...
            <td>
              <div style="display: flex; gap: var(--sp-2); justify-content: flex-end;">
                <a href="/modules/kategori/edit.php?id=<?= $kat['id_kategori'] ?>"
                ...
                <a href="/modules/kategori/delete.php?id=<?= $kat['id_kategori'] ?>"
